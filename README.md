...
Dự án được chia thành ba thành phần phần mềm chính để kiểm thử và điều khiển toàn bộ hệ thống:
...
* **`Video đồ án/`**: Thư mục chứa các kết quả nhóm chúng em đã quay lại. Do không thể đưa vào Word nên nhóm quyết định đăng lên github để lưu trữ.
---
...
---
##Phương pháp xem kết quả
Trong phần kết quả, nhóm có sử dụng 2 loại thuật toán chính, hai thuật toán cho SPWM cho mạch open-loop (mạch hàn lỗ) và thuật toán SVPWM có điều chỉnh tốc độ. Tên video đã được để theo thuật toán nhóm sử dụng hoặc mục đích sử dụng của nhóm. Tất cả các video này sẽ được đính kèm tại mục tài liệu đi kèm trong hệ thống quản lý đào tạo (https://qldt.hust.edu.vn)
